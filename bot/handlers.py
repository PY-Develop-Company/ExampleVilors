...
# це все є інтуїтивним. Тут можна самому ставити свої обмеження. Використовуйте це з розумом
...
# потім цей рутер потібно підключити до диспетчера -> dp.include_router(router)
router = Router()
